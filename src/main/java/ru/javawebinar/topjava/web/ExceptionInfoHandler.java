...
public class ExceptionInfoHandler {
    ...
    private static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType, String err) {
        ...
        return new ErrorInfo(
                req.getRequestURL(),
                errorType,
                err.equals("") ? rootCause.toString() : err
        );
    }
}